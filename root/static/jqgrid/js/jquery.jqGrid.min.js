...
typeof e?e.match(c):null,c=function(a,c){a=String(a);for(c=parseInt(c,10)||2;a.length<c;)a="0"+a;return a},g={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},k=0,l,m,k=function(a,c){0===a?12===c&&(c=0):12!==c&&(c+=12);return c};void 0===f&&(f=a.jgrid.formatter.date);void 0===f.parseRe&&(f.parseRe=/[#%\\\/:_;.,\t\s-]/);f.masks.hasOwnProperty(d)&&(d=f.masks[d]);if(e&&null!=e)if(isNaN(e-0)||"u"!==String(d).toLowerCase())if(e.constructor===Date)k=e;else if(null!==h)k=new Date(parseInt(h[1],10)),h[3]&&(d=60*Number(h[5])+
Number(h[6]),d*="-"===h[4]?1:-1,d-=k.getTimezoneOffset(),k.setTime(Number(Number(k)+6E4*d)));else{e=String(e).replace(/\T/g,"#").replace(/\t/,"%").split(f.parseRe);d=d.replace(/\T/g,"#").replace(/\t/,"%").split(f.parseRe);l=0;for(m=d.length;l<m;l++)"M"===d[l]&&(h=a.inArray(e[l],f.monthNames),-1!==h&&12>h&&(e[l]=h+1,g.m=e[l])),"F"===d[l]&&(h=a.inArray(e[l],f.monthNames,12),-1!==h&&11<h&&(e[l]=h+1-12,g.m=e[l])),"a"===d[l]&&(h=a.inArray(e[l],f.AmPm),-1!==h&&2>h&&e[l]===f.AmPm[h]&&(e[l]=h,g.h=k(e[l],
g.h))),"A"===d[l]&&(h=a.inArray(e[l],f.AmPm),-1!==h&&1<h&&e[l]===f.AmPm[h]&&(e[l]=h-2,g.h=k(e[l],g.h))),"g"===d[l]&&(g.h=parseInt(e[l],10)),void 0!==e[l]&&(g[d[l].toLowerCase()]=parseInt(e[l],10));g.f&&(g.m=g.f);if(0===g.m&&0===g.y&&0===g.d)return"&#160;";g.m=parseInt(g.m,10)-1;k=g.y;70<=k&&99>=k?g.y=1900+g.y:0<=k&&69>=k&&(g.y=2E3+g.y);k=new Date(g.y,g.m,g.d,g.h,g.i,g.s,g.u)}else k=new Date(1E3*parseFloat(e));else k=new Date(g.y,g.m,g.d,g.h,g.i,g.s,g.u);if(void 0===b)return k;f.masks.hasOwnProperty(b)?
b=f.masks[b]:b||(b="Y-m-d");d=k.getHours();e=k.getMinutes();g=k.getDate();h=k.getMonth()+1;l=k.getTimezoneOffset();m=k.getSeconds();var p=k.getMilliseconds(),r=k.getDay(),q=k.getFullYear(),n=(r+6)%7+1,s=(new Date(q,h-1,g)-new Date(q,0,1))/864E5,t={d:c(g),D:f.dayNames[r],j:g,l:f.dayNames[r+7],N:n,S:f.S(g),w:r,z:s,W:5>n?Math.floor((s+n-1)/7)+1:Math.floor((s+n-1)/7)||(4>((new Date(q-1,0,1)).getDay()+6)%7?53:52),F:f.monthNames[h-1+12],m:c(h),M:f.monthNames[h-1],n:h,t:"?",L:"?",o:"?",Y:q,y:String(q).substring(2),
a:12>d?f.AmPm[0]:f.AmPm[1],A:12>d?f.AmPm[2]:f.AmPm[3],B:"?",g:d%12||12,G:d,h:c(d%12||12),H:c(d),i:c(e),s:c(m),u:p,e:"?",I:"?",O:(0<l?"-":"+")+c(100*Math.floor(Math.abs(l)/60)+Math.abs(l)%60,4),P:"?",T:(String(k).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(k/1E3)};return b.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(a){return t.hasOwnProperty(a)?
t[a]:a.substring(1)})},jqID:function(a){return String(a).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,"\\$&")},guid:1,uidPref:"jqg",randId:function(d){return(d||a.jgrid.uidPref)+a.jgrid.guid++},getAccessor:function(a,e){var b,f,c=[],h;if("function"===typeof e)return e(a);b=a[e];if(void 0===b)try{if("string"===typeof e&&(c=e.split(".")),h=c.length)for(b=a;b&&h--;)f=c.shift(),b=b[f]}catch(g){}return b},getXmlData:function(d,e,b){var f="string"===typeof e?e.match(/^(.*)\[(\w+)\]$/):null;if("function"===
...
function(a,c){return{field:a.toString(),unique:c,items:[]}};this._toStr=function(c){g&&(c=a.trim(c));c=c.toString().replace(/\\/g,"\\\\").replace(/\"/g,'\\"');return h?c:c.toLowerCase()};this._funcLoop=function(b){var d=[];a.each(c,function(a,c){d.push(b(c))});return d};this._append=function(a){var c;k=null===k?"":k+(""===n?" && ":n);for(c=0;c<r;c++)k+="(";q&&(k+="!");k+="("+a+")";q=!1;n="";r=0};this._setCommand=function(a,c){m=a;p=c};this._resetNegate=function(){q=!1};this._repeatCommand=function(a,
c){return null===m?f:null!==a&&null!==c?m(a,c):null!==p&&t?m(p,a):m(a)};this._equals=function(a,c){return 0===f._compare(a,c,1)};this._compare=function(a,c,b){var d=Object.prototype.toString;void 0===b&&(b=1);void 0===a&&(a=null);void 0===c&&(c=null);if(null===a&&null===c)return 0;if(null===a&&null!==c)return 1;if(null!==a&&null===c)return-1;if("[object Date]"===d.call(a)&&"[object Date]"===d.call(c))return a<c?-b:a>c?b:0;h||"number"===typeof a||"number"===typeof c||(a=String(a),c=String(c));return a<
c?-b:a>c?b:0};this._performSort=function(){0!==s.length&&(c=f._doSort(c,0))};this._doSort=function(a,c){var b=s[c].by,d=s[c].dir,e=s[c].type,g=s[c].datefmt;if(c===s.length-1)return f._getOrder(a,b,d,e,g);c++;for(var b=f._getGroup(a,b,d,e,g),d=[],h,e=0;e<b.length;e++)for(h=f._doSort(b[e].items,c),g=0;g<h.length;g++)d.push(h[g]);return d};this._getOrder=function(c,b,d,e,g){var k=[],m=[],r="a"===d?1:-1,n,p;void 0===e&&(e="text");p="float"===e||"number"===e||"currency"===e||"numeric"===e?function(a){a=
parseFloat(String(a).replace(l,""));return isNaN(a)?0:a}:"int"===e||"integer"===e?function(a){return a?parseFloat(String(a).replace(l,"")):0}:"date"===e||"datetime"===e?function(c){return a.jgrid.parseDate(g,c).getTime()}:a.isFunction(e)?e:function(c){c=c?a.trim(String(c)):"";return h?c:c.toLowerCase()};a.each(c,function(c,d){n=""!==b?a.jgrid.getAccessor(d,b):d;void 0===n&&(n="");n=p(n,d);m.push({vSort:n,index:c})});m.sort(function(a,c){a=a.vSort;c=c.vSort;return f._compare(a,c,r)});e=0;for(var q=
c.length;e<q;)d=m[e].index,k.push(c[d]),e++;return k};this._getGroup=function(c,b,d,e,g){var h=[],k=null,l=null,m;a.each(f._getOrder(c,b,d,e,g),function(c,d){m=a.jgrid.getAccessor(d,b);null==m&&(m="");f._equals(l,m)||(l=m,null!==k&&h.push(k),k=f._group(b,m));k.items.push(d)});null!==k&&h.push(k);return h};this.ignoreCase=function(){h=!1;return f};this.useCase=function(){h=!0;return f};this.trim=function(){g=!0;return f};this.noTrim=function(){g=!1;return f};this.execute=function(){var b=k,d=[];if(null===
b)return f;a.each(c,function(){eval(b)&&d.push(this)});c=d;return f};this.data=function(){return c};this.select=function(b){f._performSort();if(!f._hasData())return[];f.execute();if(a.isFunction(b)){var d=[];a.each(c,function(a,c){d.push(b(c))});return d}return c};this.hasMatch=function(){if(!f._hasData())return!1;f.execute();return 0<c.length};this.andNot=function(a,c,b){q=!q;return f.and(a,c,b)};this.orNot=function(a,c,b){q=!q;return f.or(a,c,b)};this.not=function(a,c,b){return f.andNot(a,c,b)};
this.and=function(a,c,b){n=" && ";return void 0===a?f:f._repeatCommand(a,c,b)};this.or=function(a,c,b){n=" || ";return void 0===a?f:f._repeatCommand(a,c,b)};this.orBegin=function(){r++;return f};this.orEnd=function(){null!==k&&(k+=")");return f};this.isNot=function(a){q=!q;return f.is(a)};this.is=function(a){f._append("this."+a);f._resetNegate();return f};this._compareValues=function(c,b,d,e,g){var h;h=t?"jQuery.jgrid.getAccessor(this,'"+b+"')":"this";void 0===d&&(d=null);var k=d,m=void 0===g.stype?
"text":g.stype;if(null!==d)switch(m){case "int":case "integer":k=isNaN(Number(k))||""===k?"0":k;h="parseInt("+h+",10)";k="parseInt("+k+",10)";break;case "float":case "number":case "numeric":k=String(k).replace(l,"");k=isNaN(Number(k))||""===k?"0":k;h="parseFloat("+h+")";k="parseFloat("+k+")";break;case "date":case "datetime":k=String(a.jgrid.parseDate(g.newfmt||"Y-m-d",k).getTime());h='jQuery.jgrid.parseDate("'+g.srcfmt+'",'+h+").getTime()";break;default:h=f._getStr(h),k=f._getStr('"'+f._toStr(k)+
'"')}f._append(h+" "+e+" "+k);f._setCommand(c,b);f._resetNegate();return f};this.equals=function(a,c,b){return f._compareValues(f.equals,a,c,"==",b)};this.notEquals=function(a,c,b){return f._compareValues(f.equals,a,c,"!==",b)};this.isNull=function(a,c,b){return f._compareValues(f.equals,a,null,"===",b)};this.greater=function(a,c,b){return f._compareValues(f.greater,a,c,">",b)};this.less=function(a,c,b){return f._compareValues(f.less,a,c,"<",b)};this.greaterOrEquals=function(a,c,b){return f._compareValues(f.greaterOrEquals,
a,c,">=",b)};this.lessOrEquals=function(a,c,b){return f._compareValues(f.lessOrEquals,a,c,"<=",b)};this.startsWith=function(c,b){var d=null==b?c:b,d=g?a.trim(d.toString()).length:d.toString().length;t?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".substr(0,"+d+") == "+f._getStr('"'+f._toStr(b)+'"')):(null!=b&&(d=g?a.trim(b.toString()).length:b.toString().length),f._append(f._getStr("this")+".substr(0,"+d+") == "+f._getStr('"'+f._toStr(c)+'"')));f._setCommand(f.startsWith,c);f._resetNegate();
return f};this.endsWith=function(c,b){var d=null==b?c:b,d=g?a.trim(d.toString()).length:d.toString().length;t?f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".substr("+f._getStr("jQuery.jgrid.getAccessor(this,'"+c+"')")+".length-"+d+","+d+') == "'+f._toStr(b)+'"'):f._append(f._getStr("this")+".substr("+f._getStr("this")+'.length-"'+f._toStr(c)+'".length,"'+f._toStr(c)+'".length) == "'+f._toStr(c)+'"');f._setCommand(f.endsWith,c);f._resetNegate();return f};this.contains=function(a,c){t?
f._append(f._getStr("jQuery.jgrid.getAccessor(this,'"+a+"')")+'.indexOf("'+f._toStr(c)+'",0) > -1'):f._append(f._getStr("this")+'.indexOf("'+f._toStr(a)+'",0) > -1');f._setCommand(f.contains,a);f._resetNegate();return f};this.groupBy=function(a,b,d,e){return f._hasData()?f._getGroup(c,a,b,d,e):null};this.orderBy=function(c,b,d,e){b=null==b?"a":a.trim(b.toString().toLowerCase());null==d&&(d="text");null==e&&(e="Y-m-d");if("desc"===b||"descending"===b)b="d";if("asc"===b||"ascending"===b)b="a";s.push({by:c,
dir:b,type:d,datefmt:e});return f};return f}(d,null)},getMethod:function(d){return this.getAccessor(a.fn.jqGrid,d)},extend:function(d){a.extend(a.fn.jqGrid,d);this.no_legacy_api||a.fn.extend(d)}});a.fn.jqGrid=function(d){if("string"===typeof d){var e=a.jgrid.getMethod(d);if(!e)throw"jqGrid - No such method: "+d;var b=a.makeArray(arguments).slice(1);return e.apply(this,b)}return this.each(function(){if(!this.grid){var b=a.extend(!0,{url:"",height:150,page:1,rowNum:20,rowTotal:null,records:0,pager:"",
...
var c=a(e.bDiv).height();if(c){var d=a("table:first",e.bDiv),g,k;if(d[0].rows.length)try{k=(g=d[0].rows[1])?a(g).outerHeight()||e.prevRowHeight:e.prevRowHeight}catch(l){k=e.prevRowHeight}if(k){e.prevRowHeight=k;var m=b.rowNum;g=e.scrollTop=e.bDiv.scrollTop;var r=Math.round(d.position().top)-g,n=r+d.height();k*=m;var p,q,s;n<c&&0>=r&&(void 0===b.lastpage||parseInt((n+g+k-1)/k,10)<=b.lastpage)&&(q=parseInt((c-n+k-1)/k,10),0<=n||2>q||!0===b.scroll?(p=Math.round((n+g)/k)+1,r=-1):r=1);0<r&&(p=parseInt(g/
k,10)+1,q=parseInt((g+c)/k,10)+2-p,s=!0);!q||b.lastpage&&(p>b.lastpage||1===b.lastpage||p===b.page&&p===b.lastpage)||(e.hDiv.loading?e.timer=setTimeout(e.populateVisible,b.scrollTimeout):(b.page=p,s&&(e.selectionPreserver(d[0]),e.emptyRows.call(d[0],!1,!1)),e.populate(q)))}}},scrollGrid:function(a){if(b.scroll){var c=e.bDiv.scrollTop;void 0===e.scrollTop&&(e.scrollTop=0);c!==e.scrollTop&&(e.scrollTop=c,e.timer&&clearTimeout(e.timer),e.timer=setTimeout(e.populateVisible,b.scrollTimeout))}e.hDiv.scrollLeft=
...
a("<div class='ui-jqgrid-view'></div>"),m=a.jgrid.msie;c.p.direction=a.trim(c.p.direction.toLowerCase());-1===a.inArray(c.p.direction,["ltr","rtl"])&&(c.p.direction="ltr");k=c.p.direction;a(l).insertBefore(this);a(this).removeClass("scroll").appendTo(l);var p=a("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");a(p).attr({id:"gbox_"+this.id,dir:k}).insertBefore(l);a(l).attr("id","gview_"+this.id).appendTo(p);a("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+
"'></div>").insertBefore(l);a("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(l);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var r=function(a,c){a=parseInt(a,10);return isNaN(a)?c||0:a},q=function(b,d,f,g,k,l){var m=c.p.colModel[b],r=m.align,n='style="',p=m.classes,q=m.name,s=[];r&&(n+="text-align:"+r+";");!0===m.hidden&&(n+=
"display:none;");if(0===d)n+="width: "+e.headers[b].width+"px;";else if(m.cellattr&&a.isFunction(m.cellattr)&&(b=m.cellattr.call(c,k,f,g,m,l))&&"string"===typeof b)if(b=b.replace(/style/i,"style").replace(/title/i,"title"),-1<b.indexOf("title")&&(m.title=!1),-1<b.indexOf("class")&&(p=void 0),s=b.replace("-style","-sti").split(/style/),2===s.length){s[1]=a.trim(s[1].replace("-sti","-style").replace("=",""));if(0===s[1].indexOf("'")||0===s[1].indexOf('"'))s[1]=s[1].substring(1);n+=s[1].replace(/'/gi,
'"')}else n+='"';s.length||(s[0]="",n+='"');n+=(void 0!==p?' class="'+p+'"':"")+(m.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':"");n+=' aria-describedby="'+c.p.id+"_"+q+'"';return n+s[0]},n=function(b){return null==b||""===b?"&#160;":c.p.autoencode?a.jgrid.htmlEncode(b):String(b)},s=function(b,d,e,f,g){var k=c.p.colModel[e];void 0!==k.formatter?(b=""!==String(c.p.idPrefix)?a.jgrid.stripPref(c.p.idPrefix,b):b,b={rowId:b,colModel:k,gid:c.p.id,pos:e},d=a.isFunction(k.formatter)?k.formatter.call(c,d,
b,f,g):a.fmatter?a.fn.fmatter.call(c,k.formatter,d,b,f,g):n(d)):d=n(d);return d},t=function(a,c,b,d,e,f){c=s(a,c,b,e,"add");return'<td role="gridcell" '+q(b,d,c,e,a,f)+">"+c+"</td>"},v=function(a,b,d,e){e='<input role="checkbox" type="checkbox" id="jqg_'+c.p.id+"_"+a+'" class="cbox" name="jqg_'+c.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/>";return'<td role="gridcell" '+q(b,d,"",null,a,!0)+">"+e+"</td>"},u=function(a,c,b,d){b=(parseInt(b,10)-1)*parseInt(d,10)+1+c;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+
q(a,c,b,null,c,!0)+">"+b+"</td>"},w=function(a){var b,d=[],e=0,f;for(f=0;f<c.p.colModel.length;f++)b=c.p.colModel[f],"cb"!==b.name&&"subgrid"!==b.name&&"rn"!==b.name&&(d[e]="local"===a?b.name:"xml"===a||"xmlstring"===a?b.xmlmap||b.name:b.jsonmap||b.name,!1!==c.p.keyIndex&&!0===b.key&&(c.p.keyName=d[e]),e++);return d},x=function(b){var d=c.p.remapColumns;d&&d.length||(d=a.map(c.p.colModel,function(a,c){return c}));b&&(d=a.map(d,function(a){return a<b?null:a-b}));return d},y=function(c,b){var d;this.p.deepempty?
a(this.rows).slice(1).remove():(d=0<this.rows.length?this.rows[0]:null,a(this.firstChild).empty().append(d));c&&this.p.scroll&&(a(this.grid.bDiv.firstChild).css({height:"auto"}),a(this.grid.bDiv.firstChild.firstChild).css({height:0,display:"none"}),0!==this.grid.bDiv.scrollTop&&(this.grid.bDiv.scrollTop=0));!0===b&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},A=function(){var b=c.p.data.length,d,e,f;d=!0===c.p.rownumbers?1:0;e=!0===c.p.multiselect?1:0;f=!0===c.p.subGrid?1:0;d=!1===c.p.keyIndex||
!0===c.p.loadonce?c.p.localReader.id:c.p.colModel[c.p.keyIndex+e+f+d].name;for(e=0;e<b;e++)f=a.jgrid.getAccessor(c.p.data[e],d),void 0===f&&(f=String(e+1)),c.p._index[f]=e},J=function(b,d,e,f,g,k){var l="-1",h="",m;d=d?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+c.p.direction+(e?" "+e:"")+(k?" ui-state-highlight":"");k=a(c).triggerHandler("jqGridRowAttr",[f,g,b]);"object"!==typeof k&&(k=a.isFunction(c.p.rowattr)?c.p.rowattr.call(c,f,g,b):{});if(!a.isEmptyObject(k)){k.hasOwnProperty("id")&&
(b=k.id,delete k.id);k.hasOwnProperty("tabindex")&&(l=k.tabindex,delete k.tabindex);k.hasOwnProperty("style")&&(d+=k.style,delete k.style);k.hasOwnProperty("class")&&(e+=" "+k["class"],delete k["class"]);try{delete k.role}catch(r){}for(m in k)k.hasOwnProperty(m)&&(h+=" "+m+"="+k[m])}return'<tr role="row" id="'+b+'" tabindex="'+l+'" class="'+e+'"'+(""===d?"":' style="'+d+'"')+h+">"},B=function(b,d,e,f,g){var k=new Date,l="local"!==c.p.datatype&&c.p.loadonce||"xmlstring"===c.p.datatype,h=c.p.xmlReader,
m="local"===c.p.datatype?"local":"xml";l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;if(a.isXMLDoc(b)){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(y.call(c,!1,!0),e=1);var n=a(c),p,q,s=0,B,I=!0===c.p.multiselect?1:0,A=0,z,L=!0===c.p.rownumbers?1:0,M,H=[],K,C={},N,D,E=[],R=!0===c.p.altRows?c.p.altclass:"",fa;!0===c.p.subGrid&&(A=1,z=a.jgrid.getMethod("addSubGridCell"));h.repeatitems||(H=w(m));M=!1===c.p.keyIndex?a.isFunction(h.id)?h.id.call(c,b):h.id:c.p.keyIndex;0<H.length&&
!isNaN(M)&&(M=c.p.keyName);m=-1===String(M).indexOf("[")?H.length?function(c,b){return a(M,c).text()||b}:function(c,b){return a(h.cell,c).eq(M).text()||b}:function(a,c){return a.getAttribute(M.replace(/[\[\]]/g,""))||c};c.p.userData={};c.p.page=r(a.jgrid.getXmlData(b,h.page),c.p.page);c.p.lastpage=r(a.jgrid.getXmlData(b,h.total),1);c.p.records=r(a.jgrid.getXmlData(b,h.records));a.isFunction(h.userdata)?c.p.userData=h.userdata.call(c,b)||{}:a.jgrid.getXmlData(b,h.userdata,!0).each(function(){c.p.userData[this.getAttribute("name")]=
a(this).text()});b=a.jgrid.getXmlData(b,h.root,!0);(b=a.jgrid.getXmlData(b,h.row,!0))||(b=[]);var G=b.length,F=0,T=[],S=parseInt(c.p.rowNum,10),V=c.p.scroll?a.jgrid.randId():1;0<G&&0>=c.p.page&&(c.p.page=1);if(b&&G){g&&(S*=g+1);g=a.isFunction(c.p.afterInsertRow);var $=!1,Q;c.p.grouping&&($=!0===c.p.groupingView.groupCollapse,Q=a.jgrid.getMethod("groupingPrepare"));for(;F<G;){N=b[F];D=m(N,V+F);D=c.p.idPrefix+D;p=0===e?0:e+1;fa=1===(p+F)%2?R:"";var O=E.length;E.push("");L&&E.push(u(0,F,c.p.page,c.p.rowNum));
I&&E.push(v(D,L,F,!1));A&&E.push(z.call(n,I+L,F+e));if(h.repeatitems){K||(K=x(I+A+L));var U=a.jgrid.getXmlData(N,h.cell,!0);a.each(K,function(a){var b=U[this];if(!b)return!1;B=b.textContent||b.text;C[c.p.colModel[a+I+A+L].name]=B;E.push(t(D,B,a+I+A+L,F+e,N,C))})}else for(p=0;p<H.length;p++)B=a.jgrid.getXmlData(N,H[p]),C[c.p.colModel[p+I+A+L].name]=B,E.push(t(D,B,p+I+A+L,F+e,N,C));E[O]=J(D,$,fa,C,N,!1);E.push("</tr>");c.p.grouping&&(T.push(E),c.p.groupingView._locgr||Q.call(n,C,F),E=[]);if(l||!0===
c.p.treeGrid)C._id_=a.jgrid.stripPref(c.p.idPrefix,D),c.p.data.push(C),c.p._index[C._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("tbody:first",d).append(E.join("")),n.triggerHandler("jqGridAfterInsertRow",[D,C,N]),g&&c.p.afterInsertRow.call(c,D,C,N),E=[]);C={};s++;F++;if(s===S)break}}!0===c.p.gridview&&(q=-1<c.p.treeANode?c.p.treeANode:0,c.p.grouping?(l||n.jqGrid("groupingRender",T,c.p.colModel.length,c.p.page,S),T=null):!0===c.p.treeGrid&&0<q?a(c.rows[q]).after(E.join("")):a("tbody:first",d).append(E.join("")));
if(!0===c.p.subGrid)try{n.jqGrid("addSubGrid",I+L)}catch(aa){}c.p.totaltime=new Date-k;0<s&&0===c.p.records&&(c.p.records=G);E=null;if(!0===c.p.treeGrid)try{n.jqGrid("setTreeNode",q+1,s+q+1)}catch(ba){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=0);c.p.reccount=s;c.p.treeANode=-1;c.p.userDataOnFooter&&n.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=G,c.p.lastpage=Math.ceil(G/S));f||c.updatepager(!1,!0);if(l){for(;s<G;){N=b[s];D=m(N,s+V);D=c.p.idPrefix+D;if(h.repeatitems){K||(K=x(I+
A+L));var ca=a.jgrid.getXmlData(N,h.cell,!0);a.each(K,function(a){var b=ca[this];if(!b)return!1;B=b.textContent||b.text;C[c.p.colModel[a+I+A+L].name]=B})}else for(p=0;p<H.length;p++)B=a.jgrid.getXmlData(N,H[p]),C[c.p.colModel[p+I+A+L].name]=B;C._id_=a.jgrid.stripPref(c.p.idPrefix,D);c.p.grouping&&Q.call(n,C,s);c.p.data.push(C);c.p._index[C._id_]=c.p.data.length-1;C={};s++}c.p.grouping&&(c.p.groupingView._locgr=!0,n.jqGrid("groupingRender",T,c.p.colModel.length,c.p.page,S),T=null)}}},M=function(b,
d,e,f,g){var k=new Date;if(b){-1!==c.p.treeANode||c.p.scroll?e=1<e?e:1:(y.call(c,!1,!0),e=1);var h,l="local"!==c.p.datatype&&c.p.loadonce||"jsonstring"===c.p.datatype;l&&(c.p.data=[],c.p._index={},c.p.localReader.id="_id_");c.p.reccount=0;"local"===c.p.datatype?(d=c.p.localReader,h="local"):(d=c.p.jsonReader,h="json");var m=a(c),n=0,p,q,s,B=[],I=c.p.multiselect?1:0,A=!0===c.p.subGrid?1:0,z,L=!0===c.p.rownumbers?1:0,M=x(I+A+L);h=w(h);var C,H,E,K={},N,D,F=[],fa=!0===c.p.altRows?c.p.altclass:"",G;c.p.page=
r(a.jgrid.getAccessor(b,d.page),c.p.page);c.p.lastpage=r(a.jgrid.getAccessor(b,d.total),1);c.p.records=r(a.jgrid.getAccessor(b,d.records));c.p.userData=a.jgrid.getAccessor(b,d.userdata)||{};A&&(z=a.jgrid.getMethod("addSubGridCell"));E=!1===c.p.keyIndex?a.isFunction(d.id)?d.id.call(c,b):d.id:c.p.keyIndex;d.repeatitems||(B=h,0<B.length&&!isNaN(E)&&(E=c.p.keyName));H=a.jgrid.getAccessor(b,d.root);null==H&&a.isArray(b)&&(H=b);H||(H=[]);b=H.length;q=0;0<b&&0>=c.p.page&&(c.p.page=1);var R=parseInt(c.p.rowNum,
10),T=c.p.scroll?a.jgrid.randId():1,S=!1,V;g&&(R*=g+1);"local"!==c.p.datatype||c.p.deselectAfterSort||(S=!0);var $=a.isFunction(c.p.afterInsertRow),Q=[],O=!1,U;c.p.grouping&&(O=!0===c.p.groupingView.groupCollapse,U=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){g=H[q];D=a.jgrid.getAccessor(g,E);void 0===D&&("number"===typeof E&&null!=c.p.colModel[E+I+A+L]&&(D=a.jgrid.getAccessor(g,c.p.colModel[E+I+A+L].name)),void 0===D&&(D=T+q,0===B.length&&d.cell&&(p=a.jgrid.getAccessor(g,d.cell)||g,D=null!=p&&
void 0!==p[E]?p[E]:D)));D=c.p.idPrefix+D;p=1===e?0:e;G=1===(p+q)%2?fa:"";S&&(V=c.p.multiselect?-1!==a.inArray(D,c.p.selarrrow):D===c.p.selrow);var ca=F.length;F.push("");L&&F.push(u(0,q,c.p.page,c.p.rowNum));I&&F.push(v(D,L,q,V));A&&F.push(z.call(m,I+L,q+e));C=h;d.repeatitems&&(d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&(C=M));for(s=0;s<C.length;s++)p=a.jgrid.getAccessor(g,C[s]),K[c.p.colModel[s+I+A+L].name]=p,F.push(t(D,p,s+I+A+L,q+e,g,K));F[ca]=J(D,O,G,K,g,V);F.push("</tr>");c.p.grouping&&
(Q.push(F),c.p.groupingView._locgr||U.call(m,K,q),F=[]);if(l||!0===c.p.treeGrid)K._id_=a.jgrid.stripPref(c.p.idPrefix,D),c.p.data.push(K),c.p._index[K._id_]=c.p.data.length-1;!1===c.p.gridview&&(a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(F.join("")),m.triggerHandler("jqGridAfterInsertRow",[D,K,g]),$&&c.p.afterInsertRow.call(c,D,K,g),F=[]);K={};n++;q++;if(n===R)break}!0===c.p.gridview&&(N=-1<c.p.treeANode?c.p.treeANode:0,c.p.grouping?l||(m.jqGrid("groupingRender",Q,c.p.colModel.length,c.p.page,
R),Q=null):!0===c.p.treeGrid&&0<N?a(c.rows[N]).after(F.join("")):a("#"+a.jgrid.jqID(c.p.id)+" tbody:first").append(F.join("")));if(!0===c.p.subGrid)try{m.jqGrid("addSubGrid",I+L)}catch(aa){}c.p.totaltime=new Date-k;0<n&&0===c.p.records&&(c.p.records=b);if(!0===c.p.treeGrid)try{m.jqGrid("setTreeNode",N+1,n+N+1)}catch(ba){}c.p.treeGrid||c.p.scroll||(c.grid.bDiv.scrollTop=0);c.p.reccount=n;c.p.treeANode=-1;c.p.userDataOnFooter&&m.jqGrid("footerData","set",c.p.userData,!0);l&&(c.p.records=b,c.p.lastpage=
Math.ceil(b/R));f||c.updatepager(!1,!0);if(l){for(;n<b&&H[n];){g=H[n];D=a.jgrid.getAccessor(g,E);void 0===D&&("number"===typeof E&&null!=c.p.colModel[E+I+A+L]&&(D=a.jgrid.getAccessor(g,c.p.colModel[E+I+A+L].name)),void 0===D&&(D=T+n,0===B.length&&d.cell&&(e=a.jgrid.getAccessor(g,d.cell)||g,D=null!=e&&void 0!==e[E]?e[E]:D)));if(g){D=c.p.idPrefix+D;C=h;d.repeatitems&&(d.cell&&(g=a.jgrid.getAccessor(g,d.cell)||g),a.isArray(g)&&(C=M));for(s=0;s<C.length;s++)K[c.p.colModel[s+I+A+L].name]=a.jgrid.getAccessor(g,
C[s]);K._id_=a.jgrid.stripPref(c.p.idPrefix,D);c.p.grouping&&U.call(m,K,n);c.p.data.push(K);c.p._index[K._id_]=c.p.data.length-1;K={}}n++}c.p.grouping&&(c.p.groupingView._locgr=!0,m.jqGrid("groupingRender",Q,c.p.colModel.length,c.p.page,R))}}},H=function(){function b(a){var c=0,d,e,f,k,h;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&t.orBegin();for(d=0;d<a.groups.length;d++){0<c&&e&&t.or();try{b(a.groups[d])}catch(l){alert(l)}c++}e&&t.orEnd()}if(null!=a.rules)try{(f=
a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&t.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],k=a.groupOp.toString().toUpperCase(),s[h.op]&&h.field&&(0<c&&k&&"OR"===k&&(t=t.or()),t=s[h.op](t,k)(h.field,h.data,g[h.field])),c++;f&&t.orEnd()}catch(m){alert(m)}}var d=c.p.multiSort?[]:"",e=[],f=!1,g={},k=[],h=[],l,m,n;if(a.isArray(c.p.data)){var p=c.p.grouping?c.p.groupingView:!1,r,q;a.each(c.p.colModel,function(){m=this.sorttype||"text";"date"===m||"datetime"===m?(this.formatter&&
"string"===typeof this.formatter&&"date"===this.formatter?(l=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,n=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=n=this.datefmt||"Y-m-d",g[this.name]={stype:m,srcfmt:l,newfmt:n}):g[this.name]={stype:m,srcfmt:"",newfmt:""};if(c.p.grouping)for(q=0,r=p.groupField.length;q<r;q++)if(this.name===p.groupField[q]){var b=this.name;this.index&&
...
a.andNot().isNull}},t=a.jgrid.from(c.p.data);c.p.ignoreCase&&(t=t.ignoreCase());if(!0===c.p.search){var w=c.p.postData.filters;if(w)"string"===typeof w&&(w=a.jgrid.parse(w)),b(w);else try{t=s[c.p.postData.searchOper](t)(c.p.postData.searchField,c.p.postData.searchString,g[c.p.postData.searchField])}catch(v){}}if(c.p.grouping)for(q=0;q<r;q++)t.orderBy(h[q],p.groupOrder[q],k[q].stype,k[q].srcfmt);c.p.multiSort?a.each(d,function(a){t.orderBy(this,e[a],g[this].stype,g[this].srcfmt)}):d&&c.p.sortorder&&
f&&("DESC"===c.p.sortorder.toUpperCase()?t.orderBy(c.p.sortname,"d",g[d].stype,g[d].srcfmt):t.orderBy(c.p.sortname,"a",g[d].stype,g[d].srcfmt));var w=t.select(),u=parseInt(c.p.rowNum,10),x=w.length,B=parseInt(c.p.page,10),I=Math.ceil(x/u),y={};if((c.p.search||c.p.resetsearch)&&c.p.grouping&&c.p.groupingView._locgr){c.p.groupingView.groups=[];var A,z=a.jgrid.getMethod("groupingPrepare"),L,J;if(c.p.footerrow&&c.p.userDataOnFooter){for(L in c.p.userData)c.p.userData.hasOwnProperty(L)&&(c.p.userData[L]=
0);J=!0}for(A=0;A<x;A++){if(J)for(L in c.p.userData)c.p.userData[L]+=parseFloat(w[A][L]||0);z.call(a(c),w[A],A,u)}}w=w.slice((B-1)*u,B*u);g=t=null;y[c.p.localReader.total]=I;y[c.p.localReader.page]=B;y[c.p.localReader.records]=x;y[c.p.localReader.root]=w;y[c.p.localReader.userdata]=c.p.userData;w=null;return y}}},z=function(){c.grid.hDiv.loading=!0;if(!c.p.hiddengrid)switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).show();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).show(),
a("#load_"+a.jgrid.jqID(c.p.id)).show()}},C=function(){c.grid.hDiv.loading=!1;switch(c.p.loadui){case "enable":a("#load_"+a.jgrid.jqID(c.p.id)).hide();break;case "block":a("#lui_"+a.jgrid.jqID(c.p.id)).hide(),a("#load_"+a.jgrid.jqID(c.p.id)).hide()}},G=function(b){if(!c.grid.hDiv.loading){var d=c.p.scroll&&!1===b,e={},f,g=c.p.prmNames;0>=c.p.page&&(c.p.page=Math.min(1,c.p.lastpage));null!==g.search&&(e[g.search]=c.p.search);null!==g.nd&&(e[g.nd]=(new Date).getTime());null!==g.rows&&(e[g.rows]=c.p.rowNum);
null!==g.page&&(e[g.page]=c.p.page);null!==g.sort&&(e[g.sort]=c.p.sortname);null!==g.order&&(e[g.order]=c.p.sortorder);null!==c.p.rowTotal&&null!==g.totalrows&&(e[g.totalrows]=c.p.rowTotal);var k=a.isFunction(c.p.loadComplete),h=k?c.p.loadComplete:null,l=0;b=b||1;1<b?null!==g.npage?(e[g.npage]=b,l=b-1,b=1):h=function(a){c.p.page++;c.grid.hDiv.loading=!1;k&&c.p.loadComplete.call(c,a);G(b-1)}:null!==g.npage&&delete c.p.postData[g.npage];if(c.p.grouping){a(c).jqGrid("groupingSetup");var m=c.p.groupingView,
n,p="";for(n=0;n<m.groupField.length;n++){var r=m.groupField[n];a.each(c.p.colModel,function(a,c){c.name===r&&c.index&&(r=c.index)});p+=r+" "+m.groupOrder[n]+", "}e[g.sort]=p+e[g.sort]}a.extend(c.p.postData,e);var q=c.p.scroll?c.rows.length-1:1,e=a(c).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e)if(a.isFunction(c.p.datatype))c.p.datatype.call(c,c.p.postData,"load_"+c.p.id,q,b,l);else{if(a.isFunction(c.p.beforeRequest)&&(e=c.p.beforeRequest.call(c),void 0===e&&(e=!0),!1===e))return;
...
[e]);d&&c.grid.populateVisible();if(c.p.loadonce||c.p.treeGrid)c.p.datatype="local";1===b&&C()}},error:function(d,e,f){a.isFunction(c.p.loadError)&&c.p.loadError.call(c,d,e,f);1===b&&C()},beforeSend:function(b,d){var e=!0;a.isFunction(c.p.loadBeforeSend)&&(e=c.p.loadBeforeSend.call(c,b,d));void 0===e&&(e=!0);if(!1===e)return!1;z()}},a.jgrid.ajaxOptions,c.p.ajaxGridOptions));break;case "xmlstring":z();e="string"!==typeof c.p.datastr?c.p.datastr:a.parseXML(c.p.datastr);B(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",
[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;C();break;case "jsonstring":z();e="string"===typeof c.p.datastr?a.jgrid.parse(c.p.datastr):c.p.datastr;M(e,c.grid.bDiv);a(c).triggerHandler("jqGridLoadComplete",[e]);k&&c.p.loadComplete.call(c,e);a(c).triggerHandler("jqGridAfterLoadComplete",[e]);c.p.datatype="local";c.p.datastr=null;C();break;case "local":case "clientside":z(),c.p.datatype="local",e=H(),M(e,c.grid.bDiv,q,1<
b,l),a(c).triggerHandler("jqGridLoadComplete",[e]),h&&h.call(c,e),a(c).triggerHandler("jqGridAfterLoadComplete",[e]),d&&c.grid.populateVisible(),C()}}}},O=function(b){a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.hDiv)[c.p.useProp?"prop":"attr"]("checked",b);if(c.p.frozenColumns&&c.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(c.p.id),c.grid.fhDiv)[c.p.useProp?"prop":"attr"]("checked",b)},W=function(b,d){var e="",f="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
g="",h,l,m,n,p=function(b){var d;a.isFunction(c.p.onPaging)&&(d=c.p.onPaging.call(c,b));if("stop"===d)return!1;c.p.selrow=null;c.p.multiselect&&(c.p.selarrrow=[],O(!1));c.p.savedRow=[];return!0};b=b.substr(1);d+="_"+b;h="pg_"+b;l=b+"_left";m=b+"_center";n=b+"_right";a("#"+a.jgrid.jqID(b)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+
l+"' align='left'></td><td id='"+m+"' align='center' style='white-space:pre;'></td><td id='"+n+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr");if(0<c.p.rowList.length){g="<td dir='"+k+"'>";g+="<select class='ui-pg-selbox' role='listbox'>";for(l=0;l<c.p.rowList.length;l++)g+='<option role="option" value="'+c.p.rowList[l]+'"'+(c.p.rowNum===c.p.rowList[l]?' selected="selected"':"")+">"+c.p.rowList[l]+"</option>";g+="</select></td>"}"rtl"===k&&(f+=g);!0===c.p.pginput&&(e="<td dir='"+
...
c.p.viewrecords&&a("td#"+b+"_"+c.p.recordpos,"#"+h).append("<div dir='"+k+"' style='text-align:"+c.p.recordpos+"' class='ui-paging-info'></div>");a("td#"+b+"_"+c.p.pagerpos,"#"+h).append(f);g=a(".ui-jqgrid").css("font-size")||"11px";a(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+g+";visibility:hidden;' ></div>");f=a(f).clone().appendTo("#testpg").width();a("#testpg").remove();0<f&&(""!==e&&(f+=50),a("td#"+b+"_"+c.p.pagerpos,"#"+h).width(f));
c.p._nvtd=[];c.p._nvtd[0]=f?Math.floor((c.p.width-f)/2):Math.floor(c.p.width/3);c.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+h).bind("change",function(){if(!p("records"))return!1;c.p.page=Math.round(c.p.rowNum*(c.p.page-1)/this.value-0.5)+1;c.p.rowNum=this.value;c.p.pager&&a(".ui-pg-selbox",c.p.pager).val(this.value);c.p.toppager&&a(".ui-pg-selbox",c.p.toppager).val(this.value);G();return!1});!0===c.p.pgbuttons&&(a(".ui-pg-button","#"+h).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor=
...
0===b&&(l=h=!1,b=e-1);if(!p(this.id))return!1;this.id==="first"+d&&g&&(c.p.page=1,f=!0);this.id==="prev"+d&&k&&(c.p.page=b-1,f=!0);this.id==="next"+d&&h&&(c.p.page=b+1,f=!0);this.id==="last"+d&&l&&(c.p.page=e,f=!0);f&&G();return!1}));!0===c.p.pginput&&a("input.ui-pg-input","#"+h).keypress(function(b){if(13===(b.charCode||b.keyCode||0)){if(!p("user"))return!1;a(this).val(r(a(this).val(),1));c.p.page=0<a(this).val()?a(this).val():c.p.page;G();return!1}return this})},Y=function(b,d){var e,f="",g=c.p.colModel,
k=!1,h;h=c.p.frozenColumns?d:c.grid.headers[b].el;var l="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[b].lso)if("asc"===g[b].lso)g[b].lso+="-desc",l="desc";else if("desc"===g[b].lso)g[b].lso+="-asc",l="asc";else{if("asc-desc"===g[b].lso||"desc-asc"===g[b].lso)g[b].lso=""}else g[b].lso=l=g[b].firstsortorder||"asc";l?(a("span.s-ico",h).show(),a("span.ui-icon-"+l,h).removeClass("ui-state-disabled"),a(h).attr("aria-selected","true")):c.p.viewsortcols[0]||
a("span.s-ico",h).hide();c.p.sortorder="";a.each(g,function(a){this.lso&&(0<a&&k&&(f+=", "),e=this.lso.split("-"),f+=g[a].index||g[a].name,f+=" "+e[e.length-1],k=!0,c.p.sortorder=e[e.length-1])});h=f.lastIndexOf(c.p.sortorder);f=f.substring(0,h);c.p.sortname=f},D=function(b,d,e,f,g){if(c.p.colModel[d].sortable&&!(0<c.p.savedRow.length)){e||(c.p.lastsort===d?"asc"===c.p.sortorder?c.p.sortorder="desc":"desc"===c.p.sortorder&&(c.p.sortorder="asc"):c.p.sortorder=c.p.colModel[d].firstsortorder||"asc",
...
(c.p.selrow=null,c.p.multiselect&&O(!1),c.p.selarrrow=[],c.p.savedRow=[]),c.p.scroll&&(g=c.grid.bDiv.scrollLeft,y.call(c,!0,!1),c.grid.hDiv.scrollLeft=g),c.p.subGrid&&"local"===c.p.datatype&&a("td.sgexpanded","#"+a.jgrid.jqID(c.p.id)).each(function(){a(this).trigger("click")}),G(),c.p.lastsort=d,c.p.sortname!==b&&d&&(c.p.lastsort=d))}},aa=function(b){b=a(c.grid.headers[b].el);b=[b.position().left+b.outerWidth()];"rtl"===c.p.direction&&(b[0]=c.p.width-b[0]);b[0]-=c.grid.bDiv.scrollLeft;b.push(a(c.grid.hDiv).position().top);
b.push(a(c.grid.bDiv).offset().top-a(c.grid.hDiv).offset().top+a(c.grid.bDiv).height());return b},Q=function(b){var d,e=c.grid.headers,f=a.jgrid.getCellIndex(b);for(d=0;d<e.length;d++)if(b===e[d].el){f=d;break}return f};this.p.id=this.id;-1===a.inArray(c.p.multikey,["shiftKey","altKey","ctrlKey"])&&(c.p.multikey=!1);c.p.keyIndex=!1;c.p.keyName=!1;for(g=0;g<c.p.colModel.length;g++)c.p.colModel[g]=a.extend(!0,{},c.p.cmTemplate,c.p.colModel[g].template||{},c.p.colModel[g]),!1===c.p.keyIndex&&!0===c.p.colModel[g].key&&
(c.p.keyIndex=g);c.p.sortorder=c.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();!0===c.p.grouping&&(c.p.scroll=!1,c.p.rownumbers=!1,c.p.treeGrid=!1,c.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(ba){}"local"!==c.p.datatype&&(c.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(c).jqGrid("setSubGrid")}catch(ga){}this.p.multiselect&&(this.p.colNames.unshift("<input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/>"),this.p.colModel.unshift({name:"cb",
width:a.jgrid.cell_width?c.p.multiselectWidth+c.p.cellLayout:c.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:c.p.rownumWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));c.p.xmlReader=a.extend(!0,{root:"rows",row:"row",page:"rows>page",total:"rows>total",records:"rows>records",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",
row:"row",repeatitems:!0,cell:"cell"}},c.p.xmlReader);c.p.jsonReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.jsonReader);c.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},c.p.localReader);c.p.scroll&&(c.p.pgbuttons=!1,c.p.pginput=
!1,c.p.rowList=[]);c.p.data.length&&A();var I="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",L,K,N,V,T,E,F,R,ja=R="",S=[],ca=[];K=[];if(!0===c.p.shrinkToFit&&!0===c.p.forceFit)for(g=c.p.colModel.length-1;0<=g;g--)if(!c.p.colModel[g].hidden){c.p.colModel[g].resizable=!1;break}"horizontal"===c.p.viewsortcols[1]&&(R=" ui-i-asc",ja=" ui-i-desc");L=m?"class='ui-th-div-ie'":"";R="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+R+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+
k+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ja+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+k+"'></span></span>");if(c.p.multiSort)for(S=c.p.sortname.split(","),g=0;g<S.length;g++)K=a.trim(S[g]).split(" "),S[g]=a.trim(K[0]),ca[g]=K[1]?a.trim(K[1]):c.p.sortorder||"asc";for(g=0;g<this.p.colNames.length;g++)K=c.p.headertitles?' title="'+a.jgrid.stripHtml(c.p.colNames[g])+'"':"",I+="<th id='"+c.p.id+"_"+c.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+
k+"'"+K+">",K=c.p.colModel[g].index||c.p.colModel[g].name,I+="<div id='jqgh_"+c.p.id+"_"+c.p.colModel[g].name+"' "+L+">"+c.p.colNames[g],c.p.colModel[g].width=c.p.colModel[g].width?parseInt(c.p.colModel[g].width,10):150,"boolean"!==typeof c.p.colModel[g].title&&(c.p.colModel[g].title=!0),c.p.colModel[g].lso="",K===c.p.sortname&&(c.p.lastsort=g),c.p.multiSort&&(K=a.inArray(K,S),-1!==K&&(c.p.colModel[g].lso=ca[K])),I+=R+"</div></th>";I+="</tr></thead>";R=null;a(this).append(I);a("thead tr:first th",
this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var $=[],da;a("#cb_"+a.jgrid.jqID(c.p.id),this).bind("click",function(){c.p.selarrrow=[];var b=!0===c.p.frozenColumns?c.p.id+"_frozen":"";this.checked?(a(c.rows).each(function(d){0<d&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&!a(this).hasClass("ui-state-disabled")&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?"prop":"attr"]("checked",
!0),a(this).addClass("ui-state-highlight").attr("aria-selected","true"),c.p.selarrrow.push(this.id),c.p.selrow=this.id,b&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).addClass("ui-state-highlight")))}),da=!0,$=[]):(a(c.rows).each(function(d){0<d&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id))[c.p.useProp?
"prop":"attr"]("checked",!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),$.push(this.id),b&&(a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(this.id),c.grid.fbDiv)[c.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),c.grid.fbDiv).removeClass("ui-state-highlight")))}),c.p.selrow=null,da=!1);a(c).triggerHandler("jqGridSelectAll",[da?c.p.selarrrow:$,da]);a.isFunction(c.p.onSelectAll)&&c.p.onSelectAll.call(c,da?c.p.selarrrow:$,da)})}!0===c.p.autowidth&&(I=
a(p).innerWidth(),c.p.width=0<I?I:"nw");(function(){var b=0,d=a.jgrid.cell_width?0:r(c.p.cellLayout,0),f=0,g,k=r(c.p.scrollOffset,0),l,m=!1,n,p=0,q;a.each(c.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(c.p.grouping&&c.p.autowidth){var e=a.inArray(this.name,c.p.groupingView.groupField);0<=e&&c.p.groupingView.groupColumnShow.length>e&&(this.hidden=!c.p.groupingView.groupColumnShow[e])}this.widthOrg=l=r(this.width,0);!1===this.hidden&&(b+=l+d,this.fixed?p+=l+d:f++)});isNaN(c.p.width)&&
(c.p.width=b+(!1!==c.p.shrinkToFit||isNaN(c.p.height)?0:k));e.width=c.p.width;c.p.tblwidth=b;!1===c.p.shrinkToFit&&!0===c.p.forceFit&&(c.p.forceFit=!1);!0===c.p.shrinkToFit&&0<f&&(n=e.width-d*f-p,isNaN(c.p.height)||(n-=k,m=!0),b=0,a.each(c.p.colModel,function(a){!1!==this.hidden||this.fixed||(this.width=l=Math.round(n*this.width/(c.p.tblwidth-d*f-p)),b+=l,g=a)}),q=0,m?e.width-p-(b+d*f)!==k&&(q=e.width-p-(b+d*f)-k):m||1===Math.abs(e.width-p-(b+d*f))||(q=e.width-p-(b+d*f)),c.p.colModel[g].width+=q,
c.p.tblwidth=b+q+d*f+p,c.p.tblwidth>c.p.width&&(c.p.colModel[g].width-=c.p.tblwidth-parseInt(c.p.width,10),c.p.tblwidth=c.p.width))})();a(p).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+c.p.id+"'>&#160;</div>");a(l).css("width",e.width+"px");var I=a("thead:first",c).get(0),U="";c.p.footerrow&&(U+="<table role='grid' style='width:"+c.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
k+"'>");var l=a("tr:first",I),ea="<tr class='jqgfirstrow' role='row' style='height:auto'>";c.p.disableClick=!1;a("th",l).each(function(b){N=c.p.colModel[b].width;void 0===c.p.colModel[b].resizable&&(c.p.colModel[b].resizable=!0);c.p.colModel[b].resizable?(V=document.createElement("span"),a(V).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+k).css("cursor","col-resize"),a(this).addClass(c.p.resizeclass)):V="";a(this).css("width",N+"px").prepend(V);V=null;var d="";c.p.colModel[b].hidden&&
(a(this).css("display","none"),d="display:none;");ea+="<td role='gridcell' style='height:0px;width:"+N+"px;"+d+"'></td>";e.headers[b]={width:N,el:this};T=c.p.colModel[b].sortable;"boolean"!==typeof T&&(T=c.p.colModel[b].sortable=!0);d=c.p.colModel[b].name;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&c.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");T&&(c.p.multiSort?c.p.viewsortcols[0]?(a("div span.s-ico",this).show(),c.p.colModel[b].lso&&a("div span.ui-icon-"+c.p.colModel[b].lso,this).removeClass("ui-state-disabled")):
c.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+c.p.colModel[b].lso,this).removeClass("ui-state-disabled")):c.p.viewsortcols[0]?(a("div span.s-ico",this).show(),b===c.p.lastsort&&a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")):b===c.p.lastsort&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+c.p.sortorder,this).removeClass("ui-state-disabled")));c.p.footerrow&&(U+="<td role='gridcell' "+q(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){if(1===
a(b.target).closest("th>span.ui-jqgrid-resize").length){var d=Q(this);if(!0===c.p.forceFit){var f=c.p,g=d,k;for(k=d+1;k<c.p.colModel.length;k++)if(!0!==c.p.colModel[k].hidden){g=k;break}f.nv=g-d}e.dragStart(d,b,aa(d));return!1}}).click(function(b){if(c.p.disableClick)return c.p.disableClick=!1;var d="th>div.ui-jqgrid-sortable",e,f;c.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");b=a(b.target).closest(d);if(1===b.length){var g;if(c.p.frozenColumns){var k=a(this)[0].id.substring(c.p.id.length+
1);a(c.p.colModel).each(function(a){if(this.name===k)return g=a,!1})}else g=Q(this);c.p.viewsortcols[2]||(e=!0,f=b.attr("sort"));null!=g&&D(a("div",this)[0].id,g,e,f,this);return!1}});if(c.p.sortable&&a.fn.sortable)try{a(c).jqGrid("sortableColumns",l)}catch(la){}c.p.footerrow&&(U+="</tr></tbody></table>");ea+="</tr>";l=document.createElement("tbody");this.appendChild(l);a(this).addClass("ui-jqgrid-btable").append(ea);var ea=null,l=a("<table class='ui-jqgrid-htable' style='width:"+c.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+
this.id+"' cellspacing='0' cellpadding='0' border='0'></table>").append(I),X=c.p.caption&&!0===c.p.hiddengrid?!0:!1;g=a("<div class='ui-jqgrid-hbox"+("rtl"===k?"-rtl":"")+"'></div>");I=null;e.hDiv=document.createElement("div");a(e.hDiv).css({width:e.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);a(g).append(l);l=null;X&&a(e.hDiv).hide();c.p.pager&&("string"===typeof c.p.pager?"#"!==c.p.pager.substr(0,1)&&(c.p.pager="#"+c.p.pager):c.p.pager="#"+a(c.p.pager).attr("id"),a(c.p.pager).css({width:e.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(p),X&&a(c.p.pager).hide(),W(c.p.pager,""));!1===c.p.cellEdit&&!0===c.p.hoverrows&&a(c).bind("mouseover",function(c){F=a(c.target).closest("tr.jqgrow");"ui-subgrid"!==a(F).attr("class")&&a(F).addClass("ui-state-hover")}).bind("mouseout",function(c){F=a(c.target).closest("tr.jqgrow");a(F).removeClass("ui-state-hover")});var P,Z,ha;a(c).before(e.hDiv).click(function(b){E=b.target;F=a(E,c.rows).closest("tr.jqgrow");if(0===a(F).length||
-1<F[0].className.indexOf("ui-state-disabled")||(a(E,c).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==c.id)return this;var d=a(E).hasClass("cbox"),e=a(c).triggerHandler("jqGridBeforeSelectRow",[F[0].id,b]);(e=!1===e||"stop"===e?!1:!0)&&a.isFunction(c.p.beforeSelectRow)&&(e=c.p.beforeSelectRow.call(c,F[0].id,b));if("A"!==E.tagName&&("INPUT"!==E.tagName&&"TEXTAREA"!==E.tagName&&"OPTION"!==E.tagName&&"SELECT"!==E.tagName||d)&&!0===e)if(P=F[0].id,Z=a.jgrid.getCellIndex(E),
ha=a(E).closest("td,th").html(),a(c).triggerHandler("jqGridCellSelect",[P,Z,ha,b]),a.isFunction(c.p.onCellSelect)&&c.p.onCellSelect.call(c,P,Z,ha,b),!0===c.p.cellEdit)if(c.p.multiselect&&d)a(c).jqGrid("setSelection",P,!0,b);else{P=F[0].rowIndex;try{a(c).jqGrid("editCell",P,Z,!0)}catch(f){}}else if(c.p.multikey)b[c.p.multikey]?a(c).jqGrid("setSelection",P,!0,b):c.p.multiselect&&d&&(d=a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P).is(":checked"),a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+P)[c.p.useProp?"prop":"attr"]("checked",
d));else{if(c.p.multiselect&&c.p.multiboxonly&&!d){var g=c.p.frozenColumns?c.p.id+"_frozen":"";a(c.p.selarrrow).each(function(b,d){var e=a(c).jqGrid("getGridRowById",d);a(e).removeClass("ui-state-highlight");a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d))[c.p.useProp?"prop":"attr"]("checked",!1);g&&(a("#"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(c.p.id)+"_"+a.jgrid.jqID(d),"#"+a.jgrid.jqID(g))[c.p.useProp?"prop":"attr"]("checked",!1))});c.p.selarrrow=
[]}a(c).jqGrid("setSelection",P,!0,b)}}).bind("reloadGrid",function(b,d){!0===c.p.treeGrid&&(c.p.datatype=c.p.treedatatype);d&&d.current&&c.grid.selectionPreserver(c);"local"===c.p.datatype?(a(c).jqGrid("resetSelection"),c.p.data.length&&A()):c.p.treeGrid||(c.p.selrow=null,c.p.multiselect&&(c.p.selarrrow=[],O(!1)),c.p.savedRow=[]);c.p.scroll&&y.call(c,!0,!1);if(d&&d.page){var e=d.page;e>c.p.lastpage&&(e=c.p.lastpage);1>e&&(e=1);c.p.page=e;c.grid.bDiv.scrollTop=c.grid.prevRowHeight?(e-1)*c.grid.prevRowHeight*
c.p.rowNum:0}c.grid.prevRowHeight&&c.p.scroll?(delete c.p.lastpage,c.grid.populateVisible()):c.grid.populate();!0===c.p._inlinenav&&a(c).jqGrid("showAddEditButtons");return!1}).dblclick(function(b){E=b.target;F=a(E,c.rows).closest("tr.jqgrow");0!==a(F).length&&(P=F[0].rowIndex,Z=a.jgrid.getCellIndex(E),a(c).triggerHandler("jqGridDblClickRow",[a(F).attr("id"),P,Z,b]),a.isFunction(c.p.ondblClickRow)&&c.p.ondblClickRow.call(c,a(F).attr("id"),P,Z,b))}).bind("contextmenu",function(b){E=b.target;F=a(E,
c.rows).closest("tr.jqgrow");0!==a(F).length&&(c.p.multiselect||a(c).jqGrid("setSelection",F[0].id,!0,b),P=F[0].rowIndex,Z=a.jgrid.getCellIndex(E),a(c).triggerHandler("jqGridRightClickRow",[a(F).attr("id"),P,Z,b]),a.isFunction(c.p.onRightClickRow)&&c.p.onRightClickRow.call(c,a(F).attr("id"),P,Z,b))});e.bDiv=document.createElement("div");m&&"auto"===String(c.p.height).toLowerCase()&&(c.p.height="100%");a(e.bDiv).append(a('<div style="position:relative;'+(m&&8>a.jgrid.msiever()?"height:0.01%;":"")+
'"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:c.p.height+(isNaN(c.p.height)?"":"px"),width:e.width+"px"}).scroll(e.scrollGrid);a("table:first",e.bDiv).css({width:c.p.tblwidth+"px"});a.support.tbody||2===a("tbody",this).length&&a("tbody:gt(0)",this).remove();c.p.multikey&&(a.jgrid.msie?a(e.bDiv).bind("selectstart",function(){return!1}):a(e.bDiv).bind("mousedown",function(){return!1}));X&&a(e.bDiv).hide();e.cDiv=document.createElement("div");var ia=!0===c.p.hidegrid?
...
e.cDiv).trigger("click")))}else a(e.cDiv).hide();a(e.hDiv).after(e.bDiv).mousemove(function(a){if(e.resizing)return e.dragMove(a),!1});a(".ui-jqgrid-labels",e.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+c.p.id,function(){return e.resizing?(e.dragEnd(),!1):!0});c.formatCol=q;c.sortData=D;c.updatepager=function(b,d){var e,f,g,k,h,l,m,n="",p=c.p.pager?"_"+a.jgrid.jqID(c.p.pager.substr(1)):"",q=c.p.toppager?"_"+c.p.toppager.substr(1):"";g=parseInt(c.p.page,10)-1;0>
g&&(g=0);g*=parseInt(c.p.rowNum,10);h=g+c.p.reccount;if(c.p.scroll){e=a("tbody:first > tr:gt(0)",c.grid.bDiv);g=h-e.length;c.p.reccount=e.length;if(e=e.outerHeight()||c.grid.prevRowHeight)f=g*e,m=parseInt(c.p.records,10)*e,a(">div:first",c.grid.bDiv).css({height:m}).children("div:first").css({height:f,display:f?"":"none"}),0==c.grid.bDiv.scrollTop&&1<c.p.page&&(c.grid.bDiv.scrollTop=c.p.rowNum*(c.p.page-1)*e);c.grid.bDiv.scrollLeft=c.grid.hDiv.scrollLeft}n=c.p.pager||"";if(n+=c.p.toppager?n?","+c.p.toppager:
c.p.toppager:"")m=a.jgrid.formatter.integer||{},e=r(c.p.page),f=r(c.p.lastpage),a(".selbox",n)[this.p.useProp?"prop":"attr"]("disabled",!1),!0===c.p.pginput&&(a(".ui-pg-input",n).val(c.p.page),k=c.p.toppager?"#sp_1"+p+",#sp_1"+q:"#sp_1"+p,a(k).html(a.fmatter?a.fmatter.util.NumberFormat(c.p.lastpage,m):c.p.lastpage)),c.p.viewrecords&&(0===c.p.reccount?a(".ui-paging-info",n).html(c.p.emptyrecords):(k=g+1,l=c.p.records,a.fmatter&&(k=a.fmatter.util.NumberFormat(k,m),h=a.fmatter.util.NumberFormat(h,m),
l=a.fmatter.util.NumberFormat(l,m)),a(".ui-paging-info",n).html(a.jgrid.format(c.p.recordtext,k,h,l)))),!0===c.p.pgbuttons&&(0>=e&&(e=f=0),1===e||0===e?(a("#first"+p+", #prev"+p).addClass("ui-state-disabled").removeClass("ui-state-hover"),c.p.toppager&&a("#first_t"+q+", #prev_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#first"+p+", #prev"+p).removeClass("ui-state-disabled"),c.p.toppager&&a("#first_t"+q+", #prev_t"+q).removeClass("ui-state-disabled")),e===f||0===e?(a("#next"+
p+", #last"+p).addClass("ui-state-disabled").removeClass("ui-state-hover"),c.p.toppager&&a("#next_t"+q+", #last_t"+q).addClass("ui-state-disabled").removeClass("ui-state-hover")):(a("#next"+p+", #last"+p).removeClass("ui-state-disabled"),c.p.toppager&&a("#next_t"+q+", #last_t"+q).removeClass("ui-state-disabled")));!0===b&&!0===c.p.rownumbers&&a(">td.jqgrid-rownum",c.rows).each(function(b){a(this).html(g+1+b)});d&&c.p.jqgdnd&&a(c).jqGrid("gridDnD","updateDnD");a(c).triggerHandler("jqGridGridComplete");
a.isFunction(c.p.gridComplete)&&c.p.gridComplete.call(c);a(c).triggerHandler("jqGridAfterGridComplete")};c.refreshIndex=A;c.setHeadCheckBox=O;c.constructTr=J;c.formatter=function(a,b,c,d,e){return s(a,b,c,d,e)};a.extend(e,{populate:G,emptyRows:y,beginReq:z,endReq:C});this.grid=e;c.addXmlData=function(a){B(a,c.grid.bDiv)};c.addJSONData=function(a){M(a,c.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(c).triggerHandler("jqGridInitGrid");a.isFunction(c.p.onInitGrid)&&c.p.onInitGrid.call(c);G();c.p.hiddengrid=
...
a||this.p.colModel[c].name===a){f=c;!0===this.p.frozenColumns&&!0===this.p.colModel[c].frozen&&(h=this.grid.fhDiv.find("#"+this.p.id+"_"+a));break}-1!==f&&(c=this.p.colModel[f].sortable,h||(h=this.grid.headers[f].el),"boolean"!==typeof c&&(c=!0),"boolean"!==typeof e&&(e=!1),c&&this.sortData("jqgh_"+this.p.id+"_"+a,f,e,b,h))}})},clearBeforeUnload:function(){return this.each(function(){var d=this.grid;d.emptyRows.call(this,!0,!0);a(document).unbind("mouseup.jqGrid"+this.p.id);a(d.hDiv).unbind("mousemove");
a(this).unbind();d.dragEnd=null;d.dragMove=null;d.dragStart=null;d.emptyRows=null;d.populate=null;d.populateVisible=null;d.scrollGrid=null;d.selectionPreserver=null;d.bDiv=null;d.cDiv=null;d.hDiv=null;d.cols=null;var e,b=d.headers.length;for(e=0;e<b;e++)d.headers[e].el=null;this.addJSONData=this.addXmlData=this.formatter=this.constructTr=this.setHeadCheckBox=this.refreshIndex=this.updatepager=this.sortData=this.formatCol=null})},GridDestroy:function(){return this.each(function(){if(this.grid){this.p.pager&&
...
a(n).find(">span").append(w);else throw"e2";else throw"e1";}catch(y){"e1"===y&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===y?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof y?y:y.message,a.jgrid.edit.bClose)}}}a(q).append(n);a(c).append(q);d.searchOperators||a("td:eq(0)",s).hide()});a("table thead",
...
var y=a("<td class='columns'></td>");g.append(y);var A=a("<select></select>"),J,B=[];y.append(A);A.bind("change",function(){b.field=a(A).val();v=a(this).parents("tr:first");for(h=0;h<d.p.columns.length;h++)if(d.p.columns[h].name===b.field){u=d.p.columns[h];break}if(u){u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);var c=a.jgrid.createEl.call(e,u.inputtype,u.searchoptions,"",!0,d.p.ajaxSelectOptions||{},!0);a(c).addClass("input-elm");l=
...
10)+1,a(".selectopts",v).width(f),a(".selectopts",v).css("width","auto"));a(".data",v).empty().append(c);a.jgrid.bindEv.call(e,c,u.searchoptions);a(".input-elm",v).bind("change",function(c){c=c.target;b.data="SPAN"===c.nodeName.toUpperCase()&&u.searchoptions&&a.isFunction(u.searchoptions.custom_value)?u.searchoptions.custom_value.call(e,a(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(h=y=0;h<d.p.columns.length;h++){x=
void 0===d.p.columns[h].search?!0:d.p.columns[h].search;var M=!0===d.p.columns[h].hidden;if(!0===d.p.columns[h].searchoptions.searchhidden&&x||x&&!M)x="",b.field===d.p.columns[h].name&&(x=" selected='selected'",y=h),w+="<option value='"+d.p.columns[h].name+"'"+x+">"+d.p.columns[h].label+"</option>"}A.append(w);w=a("<td class='operators'></td>");g.append(w);u=f.columns[y];u.searchoptions.id=a.jgrid.randId();k&&"text"===u.inputtype&&!u.searchoptions.size&&(u.searchoptions.size=10);y=a.jgrid.createEl.call(e,
u.inputtype,u.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(y).attr("readonly","true"),a(y).attr("disabled","true");var H=a("<select class='selectopts'></select>");w.append(H);H.bind("change",function(){b.op=a(H).val();v=a(this).parents("tr:first");var c=a(".input-elm",v)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
...
w.append(y);a.jgrid.bindEv.call(e,y,u.searchoptions);a(y).addClass("input-elm").bind("change",function(){b.data="custom"===u.inputtype?u.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});w=a("<td></td>");g.append(w);!0===this.p.ruleButtons&&(y=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),w.append(y),y.bind("click",function(){for(h=0;h<c.rules.length;h++)if(c.rules[h]===b){c.rules.splice(h,1);break}d.reDraw();
...
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)w=!0,u=b.index||b.name,x=a}});if(!l&&u||!1===d.multipleSearch){var y="eq";0<=x&&q[x].searchoptions&&q[x].searchoptions.sopt?y=q[x].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(y=d.sopt[0]);l={groupOp:"AND",rules:[{field:u,op:y,data:""}]}}w=!1;d.tmplNames&&d.tmplNames.length&&(w=!0,v=d.tmplLabel,v+="<select class='ui-template'>",v+="<option value='default'>Default</option>",a.each(d.tmplNames,
...
""}var x=a.extend({},this.editoptions||{},{id:g,name:g}),B=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),y=parseInt(B.rowpos,10)||l+1,A=parseInt(2*(parseInt(B.colpos,10)||1),10);"_empty"===b&&x.defaultValue&&(m=a.isFunction(x.defaultValue)?x.defaultValue.call(n):x.defaultValue);this.edittype||(this.edittype="text");n.p.autoencode&&(m=a.jgrid.htmlDecode(m));q=a.jgrid.createEl.call(n,this.edittype,x,m,!1,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||
{}));if(d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)d[n.p.id]._savedData[g]=m;a(q).addClass("FormElement");-1<a.inArray(this.edittype,["text","textarea","password","select"])&&a(q).addClass("ui-widget-content ui-corner-all");h=a(e).find("tr[rowpos="+y+"]");if(B.rowabove){var z=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+B.rowcontent+"</td></tr>");a(e).append(z);z[0].rp=y}0===h.length&&(h=a("<tr "+p+" rowpos='"+y+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(h).append(w),a(e).append(h),
h[0].rp=y);a("td:eq("+(A-2)+")",h[0]).html(void 0===B.label?c.p.colNames[u]:B.label);a("td:eq("+(A-1)+")",h[0]).append(B.elmprefix).append(q).append(B.elmsuffix);"custom"===this.edittype&&a.isFunction(x.custom_value)&&x.custom_value.call(n,a("#"+g,"#"+t),"set",m);a.jgrid.bindEv.call(n,q,x);r[l]=u;l++}});0<l&&(u=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+c.p.id+"_id' value='"+
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",u).val(b))}}function g(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&z.hasOwnProperty(b.name)&&""===z[b.name]&&(z[b.name]="null")})}function k(){var c,e=[!0,"",""],f={},k=n.p.prmNames,l,m,p,q,r,x=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+t),G]);x&&"object"===typeof x&&(z=x);a.isFunction(d[n.p.id].beforeCheckValues)&&(x=d[n.p.id].beforeCheckValues.call(n,
z,a("#"+t),G))&&"object"===typeof x&&(z=x);for(p in z)if(z.hasOwnProperty(p)&&(e=a.jgrid.checkValues.call(n,z[p],p),!1===e[0]))break;g();e[0]&&(f=a(n).triggerHandler("jqGridAddEditClickSubmit",[d[n.p.id],z,G]),void 0===f&&a.isFunction(d[n.p.id].onclickSubmit)&&(f=d[n.p.id].onclickSubmit.call(n,d[n.p.id],z,G)||{}),e=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[z,a("#"+t),G]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[n.p.id].beforeSubmit)&&(e=d[n.p.id].beforeSubmit.call(n,z,a("#"+t),G)));
if(e[0]&&!d[n.p.id].processing){d[n.p.id].processing=!0;a("#sData",u+"_2").addClass("ui-state-active");m=k.oper;l=k.id;z[m]="_empty"===a.trim(z[n.p.id+"_id"])?k.addoper:k.editoper;z[m]!==k.addoper?z[l]=z[n.p.id+"_id"]:void 0===z[l]&&(z[l]=z[n.p.id+"_id"]);delete z[n.p.id+"_id"];z=a.extend(z,d[n.p.id].editData,f);if(!0===n.p.treeGrid)for(r in z[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),z["adjacency"===n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&
(f=n.p.treeReader[r],!z.hasOwnProperty(f)||z[m]===k.addoper&&"parent_id_field"===r||delete z[f]);z[l]=a.jgrid.stripPref(n.p.idPrefix,z[l]);r=a.extend({url:d[n.p.id].url||a(n).jqGrid("getGridParam","editurl"),type:d[n.p.id].mtype,data:a.isFunction(d[n.p.id].serializeEditData)?d[n.p.id].serializeEditData.call(n,z):z,complete:function(f,g){var p;z[l]=n.p.idPrefix+z[l];300<=f.status&&304!==f.status?(e[0]=!1,e[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[f,G]),a.isFunction(d[n.p.id].errorTextFormat)?
e[1]=d[n.p.id].errorTextFormat.call(n,f,G):e[1]=g+" Status: '"+f.statusText+"'. Error code: "+f.status):(e=a(n).triggerHandler("jqGridAddEditAfterSubmit",[f,z,G]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[n.p.id].afterSubmit)&&(e=d[n.p.id].afterSubmit.call(n,f,z,G)));if(!1===e[0])a("#FormError>td",u).html(e[1]),a("#FormError",u).show();else if(n.p.autoencode&&a.each(z,function(b,c){z[b]=a.jgrid.htmlDecode(c)}),z[m]===k.addoper?(e[2]||(e[2]=a.jgrid.randId()),z[l]=e[2],d[n.p.id].reloadAfterSubmit?
a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",e[2],q,z):a(n).jqGrid("addRowData",e[2],z,b.addedrow),d[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",e[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose})):d[n.p.id].clearAfterAdd&&h("_empty",n,t)):(d[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),d[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",z[l])},
1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",z[l],z):a(n).jqGrid("setRowData",z[l],z),d[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose})),a.isFunction(d[n.p.id].afterComplete)&&(c=f,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[c,z,a("#"+t),G]);d[n.p.id].afterComplete.call(n,c,z,a("#"+t),G);c=null},500)),d[n.p.id].checkOnSubmit||d[n.p.id].checkOnUpdate)if(a("#"+t).data("disabled",
!1),"_empty"!==d[n.p.id]._savedData[n.p.id+"_id"])for(p in d[n.p.id]._savedData)d[n.p.id]._savedData.hasOwnProperty(p)&&z[p]&&(d[n.p.id]._savedData[p]=z[p]);d[n.p.id].processing=!1;a("#sData",u+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+t)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,d[n.p.id].ajaxEditOptions);r.url||d[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?d[n.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(d[n.p.id].useDataProxy?(f=n.p.dataProxy.call(n,
...
function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",u).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var s=n.p.id,t="FrmGrid_"+s,v="TblGrid_"+s,u="#"+a.jgrid.jqID(v),w={themodal:"editmod"+s,modalhead:"edithd"+s,modalcontent:"editcnt"+s,scrollelm:t},x=a.isFunction(d[n.p.id].beforeShowForm)?d[n.p.id].beforeShowForm:!1,y=a.isFunction(d[n.p.id].afterShowForm)?d[n.p.id].afterShowForm:!1,A=a.isFunction(d[n.p.id].beforeInitData)?d[n.p.id].beforeInitData:!1,J=a.isFunction(d[n.p.id].onInitializeForm)?
d[n.p.id].onInitializeForm:!1,B=!0,M=1,H=0,z,C,G,t=a.jgrid.jqID(t);"new"===e?(e="_empty",G="add",b.caption=d[n.p.id].addCaption):(b.caption=d[n.p.id].editCaption,G="edit");b.recreateForm||a(n).data("formProp")&&a.extend(d[a(this)[0].p.id],a(n).data("formProp"));var O=!0;b.checkOnUpdate&&b.jqModal&&!b.modal&&(O=!1);var W=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",B=isNaN(d[a(this)[0].p.id].datawidth)?d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+
...
width:a(b.w).width(),height:a(b.w).height(),dataheight:a("#"+t).height(),datawidth:a("#"+t).width()});b.w.remove();b.o&&b.o.remove()}});O||a("."+a.jgrid.jqID(b.overlayClass)).click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a(".fm-button","#"+a.jgrid.jqID(w.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",u+"_2").click(function(){z=
{};a("#FormError",u).hide();f();"_empty"===z[n.p.id+"_id"]?k():!0===b.checkOnSubmit?(C=l(z,d[n.p.id]._savedData))?(a("#"+t).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(w.themodal)).show()):k():k();return!1});a("#cData",u+"_2").click(function(){if(!m())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(w.themodal),{gb:"#gbox_"+a.jgrid.jqID(s),jqm:b.jqModal,onClose:d[n.p.id].onClose});return!1});a("#nData",u+"_2").click(function(){if(!m())return!1;a("#FormError",u).hide();var c=q();c[0]=parseInt(c[0],
...
w="",u=["integer","number","currency"],t=0,x=0,v,y,A;for(r=1;r<=f;r++)w+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?t=Math.max(t,parseInt(this.width,10)):x=Math.max(x,parseInt(this.width,10)))});v=0!==t?t:0!==x?x:0;q=a(d).jqGrid("getInd",
c);a(d.p.colModel).each(function(b){g=this.name;y=!1;n=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";A="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&A){m=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();y="right"===this.align&&0!==v?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||
...
y&&a("td:eq("+(s-1)+") span",h[0]).css({"text-align":"right",width:v+"px"});p[l]=b;l++}});0<l&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=l+99,a(e).append(c));return p}function h(b,c){var d,e,f=0,g,h;if(h=a(c).jqGrid("getInd",b,!0))a("td",h).each(function(b){d=c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?
...
m,n="ViewTbl_"+m,s={themodal:"viewmod"+m,modalhead:"viewhd"+m,modalcontent:"viewcnt"+m,scrollelm:p},t=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,v=!0,u=1,w=0;b.recreateForm||a(l).data("viewProp")&&a.extend(d[a(this)[0].p.id],a(l).data("viewProp"));var x=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",y=isNaN(d[a(this)[0].p.id].datawidth)?d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+
...
(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&w.editoptions&&!0===w.editoptions.NullIfEmpty&&""===q[r]&&(s[r]="null")}});if(!1===v[0]){try{var x=a(p).jqGrid("getGridRowById",d),y=a.jgrid.findPos(x);a.jgrid.info_dialog(a.jgrid.errors.errcap,v[1],a.jgrid.edit.bClose,{left:y[0],top:y[1]+a(x).outerHeight()})}catch(A){alert(v[1])}return m}k=p.p.prmNames;x=d;y=!1===p.p.keyIndex?k.id:p.p.colModel[p.p.keyIndex+(!0===p.p.rownumbers?1:0)+(!0===p.p.multiselect?1:0)+(!0===p.p.subGrid?1:0)].name;q&&(q[k.oper]=
k.editoper,void 0===q[y]||""===q[y]?q[y]=d:u.id!==p.p.idPrefix+q[y]&&(k=a.jgrid.stripPref(p.p.idPrefix,d),void 0!==p.p._index[k]&&(p.p._index[q[y]]=p.p._index[k],delete p.p._index[k]),d=p.p.idPrefix+q[y],a(u).attr("id",d),p.p.selrow===x&&(p.p.selrow=d),a.isArray(p.p.selarrrow)&&(k=a.inArray(x,p.p.selarrrow),0<=k&&(p.p.selarrrow[k]=d)),p.p.multiselect&&(k="jqg_"+p.p.id+"_"+d,a("input.cbox",u).attr("id",k).attr("name",k))),void 0===p.p.inlineData&&(p.p.inlineData={}),q=a.extend({},q,p.p.inlineData,
l.extraparam));if("clientArray"===l.url){q=a.extend({},q,n);p.p.autoencode&&a.each(q,function(b,c){q[b]=a.jgrid.htmlDecode(c)});k=a(p).jqGrid("setRowData",d,q);a(u).attr("editable","0");for(y=0;y<p.p.savedRow.length;y++)if(String(p.p.savedRow[y].id)===String(x)){t=y;break}0<=t&&p.p.savedRow.splice(t,1);a(p).triggerHandler("jqGridInlineAfterSaveRow",[d,k,q,l]);a.isFunction(l.aftersavefunc)&&l.aftersavefunc.call(p,d,k,l);m=!0;a(u).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(p.p.id)).show(),
s=a.extend({},q,s),s[y]=a.jgrid.stripPref(p.p.idPrefix,s[y]),a.ajax(a.extend({url:l.url,data:a.isFunction(p.p.serializeRowData)?p.p.serializeRowData.call(p,s):s,type:l.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(p.p.id)).hide();if("success"===c){var e=!0,f;f=a(p).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,l]);a.isArray(f)||(f=[!0,q]);f[0]&&a.isFunction(l.successfunc)&&(f=l.successfunc.call(p,b));a.isArray(f)?(e=f[0],q=f[1]||q):e=f;if(!0===e){p.p.autoencode&&a.each(q,function(b,
...
" tree-leaf").addClass(c.p.treeIcons.minus+" tree-minus"),c.p.data[n][g]=!1,s[r]=!0));n=v+1;void 0===b[h]&&(b[h]=!1);void 0===b[r]&&(b[r]=!1);b[k]=t;void 0===b[g]&&(b[g]=!0);"adjacency"===c.p.treeGridModel&&(b[l]=e);if("nested"===c.p.treeGridModel){var y;if(null!==e){g=parseInt(s[p],10);k=a.jgrid.from(c.p.data);k=k.greaterOrEquals(p,g,{stype:"integer"});k=k.select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][m]=k[y][m]>g?parseInt(k[y][m],10)+2:k[y][m],k[y][p]=k[y][p]>=g?parseInt(k[y][p],10)+
2:k[y][p]);b[m]=g;b[p]=g+1}else{g=parseInt(a(c).jqGrid("getCol",p,!1,"max"),10);k=a.jgrid.from(c.p.data).greater(m,g,{stype:"integer"}).select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][m]=parseInt(k[y][m],10)+2);k=a.jgrid.from(c.p.data).greater(p,g,{stype:"integer"}).select();if(k.length)for(y in k)k.hasOwnProperty(y)&&(k[y][p]=parseInt(k[y][p],10)+2);b[m]=g+1;b[p]=g+2}}if(null===e||a(c).jqGrid("isNodeLoaded",s)||w)a(c).jqGrid("addRowData",d,b,q,u),a(c).jqGrid("setTreeNode",v,n);s&&!s[h]&&
...
g.p.colModel[s[x.idx]],x.idx,k),n=x.displayValue):n=g.formatter(p,x.displayValue,s[x.idx],x.value)}catch(y){n=x.displayValue}"header"===k.groupSummaryPos[x.idx]?(l+='<tr id="'+p+'"'+(k.groupCollapse&&0<x.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+g.p.direction+" "+r+'"><td style="padding-left:'+12*x.idx+'px;">'+m+a.jgrid.template(k.groupText[x.idx],n,x.cnt,x.summary)+"</td>",l+=h(c,x.idx-1,k.groups,1),l+="</tr>"):l+='<tr id="'+p+'"'+(k.groupCollapse&&
...
colTotals:!1,formatter:"number",align:"right",summaryType:"sum",summaryRound:2,summaryRoundType:"round",summaryGroups:!0,groupSummaryPos:"header",frozenStaticCols:!1},b||{});this.each(function(){function b(a,c,e){a=d.call(a,c,e);return 0<a.length?a[0]:null}function r(a,b){var c=0,d=!0,e;for(e in a){if(a[e]!=this[c]){d=!1;break}c++;if(c>=this.length)break}d&&(t=b);return d}function q(b,c,d,e){var f=c.length,h,k,l,m;m=a.isArray(d)?d.length:1;g=[];for(l=g.root=0;l<m;l++){var n=[],p;for(h=0;h<f;h++){if(null==
d)p=k=a.trim(c[h].member)+"_"+c[h].aggregator;else{p=d[l].replace(/\s+/g,"");try{k=1===f?p:p+"_"+c[h].aggregator+"_"+h}catch(q){}}var r=e,s=k,t=n,u=k,v=e[k],w=c[h].member,x=b,y=void 0;switch(c[h].aggregator){case "sum":y=parseFloat(v||0)+parseFloat(x[w]||0);break;case "count":if(""===v||null==v)v=0;y=x.hasOwnProperty(w)?v+1:0;break;case "min":y=""===v||null==v?parseFloat(x[w]||0):Math.min(parseFloat(v),parseFloat(x[w]||0));break;case "max":y=""===v||null==v?parseFloat(x[w]||0):Math.max(parseFloat(v),
parseFloat(x[w]||0))}r[s]=t[u]=y}g[p]=n}return e}function n(a){var b,c,d,e;for(e in a)if(a.hasOwnProperty(e)){if("object"!==typeof a[e]&&("level"===e&&(void 0===O[a.level]&&(O[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(l[a.level-1]={useColSpanStyle:!1,groupHeaders:[]})),O[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level&&(l[a.level-1].groupHeaders.push({titleText:a.text}),c=l[a.level-1].groupHeaders.length,d=1===c?Y:W+(c-1)*J,l[a.level-1].groupHeaders[c-1].startColumnName=
f[d].name,l[a.level-1].groupHeaders[c-1].numberOfColumns=f.length-d,W=f.length),O[a.level]=a.text),a.level===x&&"level"===e&&0<x))if(1<J){c=1;for(b in a.fields)1===c&&l[x-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;l[x-1].groupHeaders[l[x-1].groupHeaders.length-1].numberOfColumns=c-1}else l.splice(x-1,1);null!=a[e]&&"object"===typeof a[e]&&n(a[e]);if("level"===e&&0<a.level)if(1<J)for(b in c=0,a.fields)d=m.aggregates[c].width?m.aggregates[c].width:80,f.push({name:b,
label:m.aggregates[c].label||b,width:d,formatter:m.formatter,summaryType:m.summaryType,summaryRound:m.summaryRound,summaryRoundType:m.summaryRoundType,align:m.align}),c++;else d=m.aggregates[0].width?m.aggregates[0].width:80,f.push({name:a.text,label:"_r_Totals"===a.text?m.rowTotalsText:a.text,width:d,formatter:m.formatter,summaryType:m.summaryType,summaryRound:m.summaryRound,summaryRoundType:m.summaryRoundType,align:m.align})}}var s,t,v,u=e.length,w,x,y,A=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});w=m.xDimension.length;x=m.yDimension.length;for(v=0;v<w;v++)f.push({name:m.xDimension[v].dataName,frozen:m.frozenStaticCols});for(var J=m.aggregates.length,B=w-1,M={};A<u;){s=e[A];var H=[],z=[];y={};v=0;do H[v]=a.trim(s[m.xDimension[v].dataName]),y[m.xDimension[v].dataName]=H[v],v++;while(v<w);var C=0;t=-1;v=b(c,r,H);if(!v){C=0;if(1<=x){for(C=0;C<x;C++)z[C]=a.trim(s[m.yDimension[C].dataName]),m.yDimension[C].converter&&
a.isFunction(m.yDimension[C].converter)&&(z[C]=m.yDimension[C].converter.call(this,z[C],H,z));y=q(s,m.aggregates,z,y)}else 0===x&&(y=q(s,m.aggregates,null,y));c.push(y)}else if(0<=t){C=0;if(1<=x){for(C=0;C<x;C++)z[C]=a.trim(s[m.yDimension[C].dataName]),m.yDimension[C].converter&&a.isFunction(m.yDimension[C].converter)&&(z[C]=m.yDimension[C].converter.call(this,z[C],H,z));v=q(s,m.aggregates,z,v)}else 0===x&&(v=q(s,m.aggregates,null,v));c[t]=v}s=0;var H=y=null,G;for(G in g){if(0===s)M.children&&"undefined"!==
typeof M.children||(M={text:G,level:0,children:[]}),y=M.children;else{H=null;for(v=0;v<y.length;v++)if(y[v].text===G){H=y[v];break}H?y=H.children:(y.push({children:[],text:G,level:s,fields:g[G]}),y=y[y.length-1].children)}s++}A++}var O=[],W=f.length,Y=W;0<x&&(l[x-1]={useColSpanStyle:!1,groupHeaders:[]});n(M,0);if(m.colTotals)for(A=c.length;A--;)for(v=w;v<f.length;v++)u=f[v].name,h[u]=h[u]?h[u]+parseFloat(c[A][u]||0):parseFloat(c[A][u]||0);if(0<B)for(v=0;v<B;v++)k.groupingView.groupField[v]=f[v].name,
k.groupingView.groupSummary[v]=m.summaryGroups,k.groupingView.groupSummaryPos[v]=m.groupSummaryPos;else k.grouping=!1;k.sortname=f[B].name;k.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:c,groupOptions:k,groupHeaders:l,summary:h}},jqPivot:function(d,b,f,c){return this.each(function(){function h(c){var d=jQuery(g).jqGrid("pivotSetup",c,b),e=0<a.assocArraySize(d.summary)?!0:!1,h=a.jgrid.from(d.rows);for(c=0;c<d.groupOptions.groupingView.groupField.length;c++)h.orderBy(d.groupOptions.groupingView.groupField[c],
"a","text","");jQuery(g).jqGrid(a.extend({datastr:a.extend(h.select(),e?{userdata:d.summary}:{}),datatype:"jsonstring",footerrow:e,userDataOnFooter:e,colModel:d.colModel,viewrecords:!0,sortname:b.xDimension[0].dataName},f||{},d.groupOptions));d=d.groupHeaders;if(d.length)for(c=0;c<d.length;c++)d[c]&&d[c].groupHeaders.length&&jQuery(g).jqGrid("setGroupHeaders",d[c]);b.frozenStaticCols&&jQuery(g).jqGrid("setFrozenColumns")}var g=this;"string"===typeof d?a.ajax(a.extend({url:d,dataType:"json",success:function(b,
d,e){h(a.jgrid.getAccessor(b,c&&c.reader?c.reader:"rows"))}},c||{})):h(d)})}})})(jQuery);
